...
export default function TodoItem({ item }) {
    ...
    return (
        <div className='w-410 bg-white p-2 m-2 rounded shadow-md hover:shadow-lg transition duration-300 ease-in-out w-4/5'>
            {isEditing ? (
                ...
                <div className="flex items-center justify-between ">
                    ...
                    <div className="flex">
                        <button className="text-black ml-5 hover:text-[#ff6240]" onClick={hldEdit}>
